    ...
    <article id="text__paragraphs">
        ...
        <div>
            <p>
                ...
                beside\u201d or \u201cwritten beside\u201d) is a self-contained
                unit of a discourse in writing dealing with a particular point
                or idea. A paragraph consists of one or more sentences. Though
...
{% image src="/_images/pexels-amine-photographe-14559000.webp", alt="A pink flower", aspectRatio="4" %}


            <p>
                <img
                    src="https://placehold.co/480x480?text=poko&font=Montserrat"
            ...
            <figure>
                <img
                    src="https://placehold.co/420x420?text=poko&font=Montserrat"
                    alt="Photo of a kitten"
                />
            </figure>
            <h3>
            ...
            <figure>
                <picture>
                    <source
                        srcset="
                            https://placehold.co/800x800?text=poko&font=Montserrat
                        "
    ...
    <article id="embedded__bgimages">
        ...
        <div
            style="
                background-image: url(&quot;https://placehold.co/300x300?text=poko&font=Montserrat&quot;);
                width: 300px;
                height: 300px;
            "
        ></div>
...
{% twoColumnsItem %}
{% image src="/_images/pexels-andrea-devillier-32709984.webp", alt="une fleur jaune et délicate posée" %}
{% endtwoColumnsItem %}
{% twoColumnsItem %}
...
<section id="meriton">
    ...
    <details>
        <summary>Selectionner le niveau</summary>
        <ul>
            <li>
                <label>
    ...
    <div>
        <img
            src="https://placehold.co/150x150?text=Avatar&font=Montserrat"
            alt="Avatar"
            class="avatar"
        />
    </div>
    ...
    <nav class="prose">
        <a href="/">Accueil</a> › <a href="/#">Catalogue</a> ›
        <a href="/#/#">Fleurs</a> ›
        <span>Tulipes</span>
    </nav>
